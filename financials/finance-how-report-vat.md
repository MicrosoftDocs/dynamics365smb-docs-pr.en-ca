---
title: Manage Tax Reporting to Tax Authorities| Microsoft Docs
description: Learn how to prepare a report that lists Tax from sales during a period, and submit the report to a tax authority.
...
# <a name="how-to-report-vat-to-tax-authorities"></a>How To: Report Tax to Tax Authorities
...
The EC Sales List report only works for countries in the EU. For example, it does not include Tax on sales to countries like China or the United States.
