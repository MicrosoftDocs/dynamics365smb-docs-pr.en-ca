...
* Set up tax business posting groups to define tax rates for the markets you do business in. You assign these to customers and vendors.  
* Set up tax product posting groups to define tax rates for the products and services you buy or sell.  
  
   > [!NOTE]  
>   The concepts behind Tax business and product posting groups are similar to general posting groups. For more information, see [Posting Group Setups](finance-posting-groups.md).
...
* Verify GST/HST registration numbers
...
## <a name="verify-vat-registration-numbers"></a>Verify GST/HST registration numbers
