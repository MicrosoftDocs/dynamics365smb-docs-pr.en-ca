...
You can set up tax calculations manually, but that can be tricky and time consuming. To make it easy, we've provided an assisted setup guide named **VAT Setup** that will help you with the steps. We recommend that you use the assisted setup guide to set up tax.

**Note**: You can use the guide only if you've created a My Company, and have not posted transactions that include VAT. Otherwise, it would be very easy to use different tax rates by mistake, and make tax-related reports inaccurate.  
  
If you want to set up tax calculations yourself, or just want to learn about each step, this topic contains descriptions of each step. These include how to:  
  
* Set up tax business posting groups to define tax rates for the markets you do business in. You'll assign these to customers and vendors.  
* Set up tax product posting groups to define tax rates for the products and services you buy or sell.  
...
* Combine tax business and product posting groups to create tax setups that calculate tax amounts on sales and purchases.  
* Assign tax product posting groups to the general ledger accounts you use for sales and purchases, and items, and resources.  
...
* Use reverse charge tax for trade between EU countries/regions  
* Understand tax rounding for documents  
* Set up clauses to explain the use of non-standard tax rates
* Verify tax registration numbers

## <a name="use-the-vat-setup-assisted-setup-guide-to-set-up-vat-recommended"></a>Use the Tax Setup assisted setup guide to set up tax (recommended)
...
## <a name="set-up-vat-business-posting-groups"></a>Set up tax business posting groups
...
## <a name="set-up-vat-product-posting-groups"></a>Set up tax product posting groups
...
## <a name="combine-vat-posting-groups-in-vat-posting-setups"></a>Combine tax posting groups in tax posting setups
...
## <a name="assign-vat-posting-groups-by-default-to-multiple-entities"></a>Assign tax posting groups by default to multiple entities
...
## <a name="assign-vat-posting-groups-to-individual-accounts-customers-vendors-items-and-resources"></a>Assign tax posting groups to individual accounts, customers, vendors, items, and resources
...
## <a name="set-up-clauses-to-explain-the-use-of-non-standard-vat-rates"></a>Set up clauses to explain the use of non-standard tax rates
...
## <a name="create-a-vat-posting-setup-to-handle-import-vat"></a>Create a tax posting setup to handle Import tax
You use the Import tax feature when you need to post a document where the entire amount is tax. You'll use this if you receive an invoice from the tax authorities for tax for imported goods.  
...
## <a name="verify-vat-registration-numbers"></a>Verify tax registration numbers
It's important that the tax registration numbers you have for customers, vendors, and contacts are valid. For example, companies sometimes change their tax liability status, and in some countries tax authorities might ask you to provide reports, such as the EC Sales List report, that list the tax registration numbers you use when you do business.  
