...
### <a name="does-the--app-work-with-any-localization-of-include-prod_shortmd" />Does the [!INCLUDE [prod_short.md](includes/prod_short.md)] app work with any localization of [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="does-the--app-for-teams-cater-to-my-customization-and-personalization" />Does the [!INCLUDE [prod_short.md](includes/prod_short.md)] app for Teams cater to my customization and personalization?
...
### <a name="does--synchronize-contacts-with-teams" />Does [!INCLUDE [prod_short.md](includes/prod_short.md)] synchronize contacts with Teams?
