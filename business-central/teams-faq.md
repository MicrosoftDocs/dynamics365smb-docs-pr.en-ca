...
### <a name="does-the-include-prodshortmdincludesprodshortmd-app-work-with-any-localization-of-include-prodshortmdincludesprodshortmd" />Does the [!INCLUDE [prod_short.md](includes/prod_short.md)] app work with any localization of [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="does-the-include-prodshortmdincludesprodshortmd-app-for-teams-cater-to-my-customization-and-personalization" />Does the [!INCLUDE [prod_short.md](includes/prod_short.md)] app for Teams cater to my customization and personalization?
...
### <a name="does-this-show-lists-and-records-from-my-customizations-and-add-ons" />Does this show lists and records from my customizations and add-ons?
...
### <a name="does-include-prodshortmdincludesprodshortmd-synchronize-contacts-with-teams" />Does [!INCLUDE [prod_short.md](includes/prod_short.md)] synchronize contacts with Teams?
...
### <a name="can-i-share-cards-with-users-outside-my-organization" />Can I share cards with users outside my organization?
