...
# <a name="report-vat-to-tax-authorities"></a><a name="report-vat-to-tax-authorities"></a><a name="report-vat-to-tax-authorities"></a>Report GST/HST to Tax Authorities
...
In both cases (as in other GST/HST-related reports), GST/HST is calculated based on the GST/HST posting setup and the GST/HST posting groups that you have set up. [!INCLUDE[prod_short](includes/prod_short.md)] shows GST/HST entries always based on their **GST/HST Date** as a primary reporting date.  

> [!NOTE]
> All GST/HST related reports now run using the **GST/HST Date** to filter relevant records. Even if you set up **GST/HST Date Usage** as **Do not use GST/HST Date functionallity** [!INCLUDE[prod_short](includes/prod_short.md)] will hide all instances of the **GST/HST Date** across the application. However, the **GST/HST Date** is still used in all reportings and is auto-populated with the **Posting Date**.
...
## <a name="about-the-vat-return-report"></a><a name="about-the-vat-return-report"></a><a name="about-the-vat-return-report"></a><a name="vatreturn"></a>About the GST/HST Return report
...
For the GST/HST return, you can specify the entries to include:
...
## <a name="to-set-up-vat-reports-in-"></a><a name="to-set-up-vat-reports-in-"></a><a name="to-set-up-vat-reports-in-"></a>To set up GST/HST reports in [!INCLUDE[prod_short](includes/prod_short.md)]

[!INCLUDE [vat-report-setup](includes/vat-report-setup.md)]

### <a name="to-set-up-vat-return-periods"></a><a name="to-set-up-vat-return-periods"></a><a name="to-set-up-vat-return-periods"></a>To set up GST/HST return periods
...
1. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **GST/HST Return Periods**, and then choose the related link.  
2. On the **GST/HST Return Periods** page, fill in the fields to set up the first period. [!INCLUDE [tooltip-inline-tip_md](includes/tooltip-inline-tip_md.md)].  
...
## <a name="to-prepare-and-submit-a-vat-report"></a><a name="to-prepare-and-submit-a-vat-report"></a><a name="to-prepare-and-submit-a-vat-report"></a>To prepare and submit a GST/HST report
...
3. To generate the content of the report, choose the **Suggest Lines** action.  
    ...
    > [!NOTE]  
    >  For the EC Sales List report, you can review the transactions included in the report lines before you submit the report. To do that, choose the line, and then choose the **Show GST/HST Entries** action.  
...
### <a name="vat-return-statuses"></a><a name="vat-return-statuses"></a><a name="vat-return-statuses"></a>GST/HST return statuses

GST/HST returns can have different statuses, as described in the following table.

| Status | Description |
|------------|-------------------------|
| Open | When you create a new GST/HST return. You can run the **Suggest Lines** action. If you need to correct values, you can run the **Suggest Lines** action again. You can't submit a GST/HST return that has this status. |
| Released | Status will be changed when you use the **Release** action. [!INCLUDE[prod_short](includes/prod_short.md)] will show the **Errors and Warnings** FastTab. You can't make changes or use the **Suggest Lines** action. To make changes, you must reopen the GST/HST return. |
| Rejected | If your submission was not successful (for example, if authentication failed), the status will change to **Rejected**. You can't reopen a GST/HST Return that has this status. |
...
## <a name="submitting-vat-reports-manually"></a><a name="submitting-vat-reports-manually"></a><a name="submitting-vat-reports-manually"></a>Submitting GST/HST reports manually
...
## <a name="vat-settlement"></a><a name="vat-settlement"></a><a name="vat-settlement"></a>GST/HST settlement
...
## <a name="configuring-your-own-vat-reports"></a><a name="configuring-your-own-vat-reports"></a><a name="configuring-your-own-vat-reports"></a>Configuring your own GST/HST reports
...
|----|-----|
|Suggest Lines| Fetch information from the **GST/HST Entries** table, and display it in lines on the GST/HST report.|
...
|Cancel | Send a cancellation of a GST/HST report that was submitted earlier to your tax authority. |  
