...
# <a name="report-vat-to-tax-authorities" />Report GST/HST to Tax Authorities
...
## <a name="a-namevatreturnaabout-the-vat-return-report" /><a name="vatreturn"></a>About the GST/HST Return report
...
## <a name="to-set-up-vat-reports-in-includeprodshortincludesprodshortmd" />To set up GST/HST reports in [!INCLUDE[prod_short](includes/prod_short.md)]

[!INCLUDE [vat-report-setup](includes/vat-report-setup.md)]

### <a name="to-set-up-vat-return-periods" />To set up GST/HST return periods
...
## <a name="to-prepare-and-submit-a-vat-report" />To prepare and submit a GST/HST report
...
### <a name="vat-return-statuses" />GST/HST return statuses
...
## <a name="submitting-vat-reports-manually" />Submitting GST/HST reports manually
...
## <a name="vat-settlement" />GST/HST settlement
...
## <a name="configuring-your-own-vat-reports" />Configuring your own GST/HST reports
