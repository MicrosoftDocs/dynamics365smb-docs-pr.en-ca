...
- Overall permissions according to the licence, also referred to as the entitlement.
  ...
  The licences include default permission sets. Starting in 2022 release wave 1, admins can customize these default permissions for the relevant licence types. For more information, see [Configure permissions based on licences](ui-how-users-permissions.md#licensespermissions).  
