...
## <a name="synchronize-items-and-resources-with-products-with-different-units-of-measure"></a>Synchronize items and resources with products with different units of measure
