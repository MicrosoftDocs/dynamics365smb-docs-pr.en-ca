...
|Table|Rule|
|-----|----|
|Units of Measurement|Units of measurement are synchronized with unit groups in [!INCLUDE[crm_md](includes/crm_md.md)]. There can only be one unit of measurement defined in the unit group.|
