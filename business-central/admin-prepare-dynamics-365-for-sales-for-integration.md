...
### <a name="standard-sales-entity-mapping-for-synchronization"></a><a name="standard-sales-entity-mapping-for-synchronization"></a>Standard Sales Entity Mapping for Synchronization
...
## <a name="synchronizing-items-and-resources-with-products-with-different-units-of-measure"></a><a name="synchronizing-items-and-resources-with-products-with-different-units-of-measure"></a>Synchronizing Items and Resources with Products with Different Units of Measurement
...
### <a name="synchronization-rules"></a><a name="synchronization-rules"></a>Synchronization Rules
...
|Table|Rule|
|-----|----|
|Units of Measurement|Units of measurement are synchronized with unit groups in [!INCLUDE[crm_md](includes/crm_md.md)]. There can only be one unit of measure defined in the unit group.|
...
### <a name="synchronization-jobs-for-a-sales-integration"></a><a name="synchronization-jobs-for-a-sales-integration"></a>Synchronization Jobs for a Sales Integration
...
### <a name="default-synchronization-job-queue-entries"></a><a name="default-synchronization-job-queue-entries"></a>Default Synchronization Job Queue Entries
...
|---------------------|---------------------------------------|---------------|-------------------------------|-----|-----|  
|UNITOFMEASURE - Dynamics 365 Sales synchronization job|Synchronizes [!INCLUDE[crm_md](includes/crm_md.md)] unit groups with [!INCLUDE[prod_short](includes/prod_short.md)] units of measurement.|From [!INCLUDE[prod_short](includes/prod_short.md)] to [!INCLUDE[crm_md](includes/crm_md.md)]|UNIT OF MEASUREMENT|30|720<br> (12 hrs)|
