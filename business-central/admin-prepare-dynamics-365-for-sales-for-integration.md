...
### <a name="single-and-bi-directional-synchronization-of-sales-orders"></a>Single and bi-directional synchronization of sales orders
...
### <a name="standard-sales-entity-mapping-for-synchronization"></a>Standard Sales entity mapping for synchronization
...
## <a name="synchronizing-items-and-resources-with-products-with-different-units-of-measure"></a>Synchronizing items and resources with products with different units of measure
...
### <a name="synchronization-jobs-for-a-sales-integration"></a>Synchronization jobs for a Sales integration
