...
## <a name="synchronize-items-and-resources-with-products-with-different-units-of-measure"></a>Synchronizing items and resources with products with different units of measure
