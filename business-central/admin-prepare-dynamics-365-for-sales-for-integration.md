...
### <a name="standard-sales-entity-mapping-for-synchronization" />Standard Sales Entity Mapping for Synchronization
...
## <a name="synchronizing-items-and-resources-with-products-with-different-units-of-measure" />Synchronizing Items and Resources with Products with Different Units of Measurement
...
### <a name="synchronization-rules" />Synchronization Rules
...
### <a name="synchronization-jobs-for-a-sales-integration" />Synchronization Jobs for a Sales Integration
...
### <a name="default-synchronization-job-queue-entries" />Default Synchronization Job Queue Entries
