...
|**Max. GST/HST Difference Allowed**|The maximum amount allowed for GST/HST differences in this currency. For more information, see [Correcting GST/HST amounts manually on sales and purchase documents](finance-work-with-vat.md#correcting-vat-amounts-manually-on-sales-and-purchase-documents). This field might not be visible by default. It can be retrieved by personalizing the page.|
