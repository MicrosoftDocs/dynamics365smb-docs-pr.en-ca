...
If this is not the right setup for a particular tenant, the admin can change that configuration. However, customized permissions will affect only new users who are assigned that licence. Permissions for existing users who are assigned the licence will not be affected.  
