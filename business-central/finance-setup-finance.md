...
To help you get going quickly, [!INCLUDE[d365fin](includes/d365fin_md.md)] includes standard configurations for most financial processes. If you need to change the configurations to suit your business, go right ahead. For example, from the Role Centre, you can use an assisted setup guide to set up sales tax rate for your location.  
...
|Prepare to handle unrealized Tax in connection with cash-based accounting methods.|[Set Up Unrealized Tax for Cash-Based Accounting](finance-setup-unrealized-vat.md)|
