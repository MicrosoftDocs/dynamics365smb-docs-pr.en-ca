...
> [!NOTE]
> When synchronizing the users list in Business Central with users in Microsoft 365, only users that have a Business Central licence are added to Business Central's users list. Users with only a Microsoft 365 licence are added to the users list when they access Business Central for the first time. Learn more at [Creating Users According to Licences](ui-how-users-permissions.md).
