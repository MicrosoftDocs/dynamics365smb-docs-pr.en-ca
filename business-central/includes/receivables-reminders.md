...
### <a name="to-replace-reminder-texts"></a><a name="to-replace-reminder-texts"></a><a name="to-replace-reminder-texts"></a>To replace reminder text
...
In addition, issuing the reminder may result in GST/HST entries.
