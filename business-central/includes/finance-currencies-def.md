...
ms.locfileid: "8419674"
---
You must set up a code for each currency you use if you:

- Buy or sell in other currencies besides your local currency ($).  
- Record general ledger transactions in both $ and an additional reporting currency.  
