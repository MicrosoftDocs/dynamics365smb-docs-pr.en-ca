...
The **My Job Queue** part on your Role Centre shows the job queues entries that you've started but aren't finished. By default the part isn't displayed, but you can add it to your Role Centre. To learn more about personalization, go to [Personalize Your Workspace](ui-personalization-user.md).  
...
### <a name="schedule-synchronization-between--and-includeprod_short"></a>Schedule synchronization between [!INCLUDE[prod_short](includes/prod_short.md)] and [!INCLUDE[prod_short](includes/cds_long_md.md)]
