...
The **My Job Queue** part on your Role Centre shows the job queues entries that you've started but aren't finished. By default the part isn't displayed, but you can add it to your Role Centre. For more information, see [Personalize Your Workspace](ui-personalization-user.md).  
