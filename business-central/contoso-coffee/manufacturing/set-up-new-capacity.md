...
1. Set up the work centre.
    ...
    2. Choose the **New** action, and then fill in the fields as described in the following table.  
        ...
        |**Gen. Prod. Posting Group**|NO GST/HST</br></br>Note that this selection depends on your accounting setup and country/region.|
...
2. Set up the machine centre.
    ...
    2. Choose the **New** action, and then fill in the fields as described in the following table.  
        ...
        |**Direct Unit Cost**|3.25|
        |**Flushing Method**|Manual|
        |**Gen. Prod. Posting Group**|NO GST/HST</br></br>Note that this selection depends on your accounting setup and country.|
        |**Capacity** |1|
        |**Efficiency** |90|
