...
> [!NOTE]  
>   You can also post acquisition cost as credits. In that case, remember that the value in the **Acquisition Cost Incl. GST/HST** field must be with a minus sign to indicate a credit.
...
[Design details about non-deductible GST/HST impact on Fixed Assets](design-details-nondeductible-vat.md)
