...
# <a name="get-ready-to-synchronize-master-data" />Get Ready to Synchronize Master Data
...
## <a name="uni-directional-synchronization-only" />Uni-directional synchronization only
...
## <a name="synchronize-for-the-first-time" />Synchronize for the first time
...
## <a name="add-or-delete-tables-from-the-synchronization-tables-list" />Add or delete tables from the synchronization tables list
...
## <a name="use-export-and-import-to-share-a-synchronization-setup" />Use export and import to share a synchronization setup
