...
# <a name="get-ready-to-synchronize-master-data"></a>Get Ready to Synchronize Master Data
...
## <a name="uni-directional-synchronization-only"></a>Uni-directional synchronization only
...
> [!NOTE]
> The Team Member and Internal Administrator licences let you access but not modify records, so they can't be used to set up the synchronization. The Delegated Admin licence doesn't let you schedule background tasks, so you won't be able to complete the setup.
...
## <a name="synchronize-for-the-first-time"></a>Synchronize for the first time
...
## <a name="add-or-delete-tables-from-the-synchronization-tables-list"></a>Add or delete tables from the synchronization tables list
...
## <a name="use-export-and-import-to-share-a-synchronization-setup"></a>Use export and import to share a synchronization setup
