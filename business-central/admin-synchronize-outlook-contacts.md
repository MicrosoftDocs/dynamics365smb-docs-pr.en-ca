...
ms.author: bholtorf
---
# <a name="synchronize-contacts-in-business-central-with-contacts-in-microsoft-outlook"></a><a name="synchronize-contacts-in-business-central-with-contacts-in-microsoft-outlook"></a>Synchronize Contacts in Business Central with Contacts in Microsoft Outlook
...
## <a name="set-up-synchronization"></a><a name="set-up-synchronization"></a>Set Up Synchronization
...
### <a name="automate-synchronization"></a><a name="automate-synchronization"></a>Automate synchronization
...
## <a name="synchronize-contacts"></a><a name="synchronize-contacts"></a>Synchronize Contacts
