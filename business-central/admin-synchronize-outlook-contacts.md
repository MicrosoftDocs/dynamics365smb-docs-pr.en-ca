...
ms.author: bholtorf
---
# <a name="synchronize-contacts-in-business-central-with-contacts-in-microsoft-outlook" />Synchronize Contacts in Business Central with Contacts in Microsoft Outlook
...
## <a name="set-up-synchronization" />Set Up Synchronization
...
### <a name="automate-synchronization" />Automate synchronization
...
## <a name="synchronize-contacts" />Synchronize Contacts
