...
---
# <a name="use-a-power-automate-flow-to-timely-synchronize-dataverse-entity-changes"></a>Use a Power Automate flow to timely synchronize Dataverse entity changes
