...
## <a name="vat-and-taxes"></a>GST/HST and taxes

Working with GST/HST in [!INCLUDE[prod_short](includes/prod_short.md)] is easy, and you can either use a manual or an automatic setup. These articles provide information about how to meet your country/region-specific regulations.

| To... | See |
| --- | --- |
|Calculate GST/HST on sales and purchase transactions so you can report the amounts to the tax authorities.|[Work with GST/HST on Sales and Purchases](finance-work-with-vat.md)|
...
The core of finance is centred around managing receivables and payables, registering transactions, reconciling banks accounts, paying vendors, receiving customer payments, reimbursing employees for expenses, and so on. This section provides links to the core concepts.
