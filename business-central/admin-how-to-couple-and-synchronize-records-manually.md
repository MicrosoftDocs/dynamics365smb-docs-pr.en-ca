...
# <a name="couple-and-synchronize-records-between-dataverse-and-business-central"></a>Couple and Synchronize Records between Dataverse and Business Central
...
## <a name="to-synchronize-a-single-record-from-"></a>To synchronize a single record from [!INCLUDE[crm_md](includes/crm_md.md)]
