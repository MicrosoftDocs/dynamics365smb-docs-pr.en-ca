...
# <a name="couple-and-synchronize-records-between-dataverse-and-business-central"></a><a name="couple-and-synchronize-records-between-dataverse-and-business-central"></a>Couple and Synchronize Records between Dataverse and Business Central
...
## <a name="to-synchronize-a-single-record"></a><a name="to-synchronize-a-single-record"></a>To synchronize a single record
...
## <a name="to-synchronize-a-single-record-from-"></a><a name="to-synchronize-a-single-record-from-"></a>To synchronize a single record from [!INCLUDE[crm_md](includes/crm_md.md)]
...
## <a name="to-synchronize-multiple-records"></a><a name="to-synchronize-multiple-records"></a>To synchronize multiple records
