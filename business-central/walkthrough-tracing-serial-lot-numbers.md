...
3. In the **No.** field, enter **2000**, and then proceed to fill in the following fields.  
    ...
    |Description|Base Unit of Measure|Gen. Prod. Posting Group|GST/HST Prod. Posting Group|Inventory Posting Group|Item Tracking Code|  
    |-----------|--------------------|------------------------|-----------------------|--------------------|------------------|  
...
7. In the **No.** field, enter **1002**, and then proceed to fill in the following fields.  
    ...
    |Description|Base Unit of Measure|Gen. Prod. Posting Group|GST/HST Prod. Posting Group|Inventory Posting Group|Replenishment System|Item Tracking Code|  
    |-----------------|--------------------------|------------------------------|-----------------------------|-----------------------------|--------------------------|------------------------|  
