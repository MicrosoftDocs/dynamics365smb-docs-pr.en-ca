...
2. On the **Audit File Export Setup** page, follow these steps:
    ...
    6. Select the **Check Postal/ZIP Code** checkbox to be notified about a postal code that hasn't been set up correctly.
    7. Select the **Check Address** checkbox to be notified when an address hasn't been set up correctly.
    8. In the **Default Postal/ZIP Code** field, enter the postal code to use if no postal code is specified on the customer or vendor card.
