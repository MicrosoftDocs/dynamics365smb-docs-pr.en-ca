...
ms.author: bholtorf
---
# Work with GST/HST on Sales and Purchases
...
## Calculating and displaying GST/HST amounts on sales and purchase documents  
...
### Including or excluding GST/HST in prices and line amounts
...
#### Using GST/HST business posting groups and customer price groups 
...
## Working with GST/HST Date

### GST/HST Date in documents
...
### Modifying the GST/HST Date in posted entries
...
## Correcting GST/HST amounts manually on sales and purchase documents  
...
### To set the system up for manual GST/HST entry in sales documents
...
### To adjust GST/HST for a sales document
...
## Calculating GST/HST manually using journals  
...
### To set the system up for manual GST/HST entry in a general journals
...
### To set the system up for manual GST/HST entry in a sales and purchase journals
...
## Posting Import GST/HST with Purchase Invoices
Instead of using journals to post an import GST/HST invoice, you can use a purchase invoice.  

### To set up purchasing for posting import GST/HST invoices
