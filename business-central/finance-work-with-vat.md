...
## <a name="calculating-and-displaying-vat-amounts-on-sales-and-purchase-documents"></a>Calculating and displaying GST/HST amounts on sales and purchase documents
...
> [!IMPORTANT]
> Starting in version 23.1, you can prevent or allow posting of the **GST/HST Date** for specific data range, using the **Allow GST/HST Date From** and **Allow GST/HST Date To** fields in the **GST/HST Setup** and the **User Setup**. If you are using older versions, you can prevent or allow posting of the **GST/HST Date** for specific data range, using the **Allow Posting From** and **Allow Posting To** fields in the **General Ledger Setup** and the **User Setup**.  
...
### <a name="modifying-the-vat-date-in-posted-entries"></a>Modifying the GST/HST Date in posted entries
...
## <a name="correcting-vat-amounts-manually-on-sales-and-purchase-documents"></a>Correcting GST/HST amounts manually on sales and purchase documents
