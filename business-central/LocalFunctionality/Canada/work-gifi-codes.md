...
ms.author: edupont
---
# <a name="work-with-gifi-codes-in-the-canadian-version" />Work With GIFI Codes in the Canadian Version
...
## <a name="to-set-up-gifi-codes" />To set up GIFI codes
...
## <a name="to-associate-gifi-codes-with-gl-accounts" />To associate GIFI codes with G/L accounts
...
## <a name="to-view-account-balances-using-the-gifi-code-report" />To view account balances using the GIFI code report
...
## <a name="to-export-balance-information-using-gifi-codes" />To export balance information using GIFI codes
