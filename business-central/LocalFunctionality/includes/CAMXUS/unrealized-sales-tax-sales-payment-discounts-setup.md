...
## <a name="to-set-up-unrealized-sales-tax" />To set up unrealized sales tax
...
## <a name="to-set-up-unrealized-tax-for-jurisdictions" />To set up unrealized tax for jurisdictions
...
## <a name="to-set-up-adjustments-for-payment-discounts-in-a-tax-posting-group" />To set up adjustments for payment discounts in a tax posting group
...
## <a name="to-set-up-maximum-tax-correction-amounts" />To set up maximum tax correction amounts
