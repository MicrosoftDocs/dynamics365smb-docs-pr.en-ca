...
## <a name="to-set-up-unrealized-sales-tax"></a><a name="to-set-up-unrealized-sales-tax"></a><a name="to-set-up-unrealized-sales-tax"></a>To set up unrealized sales tax
...
## <a name="to-set-up-unrealized-tax-for-jurisdictions"></a><a name="to-set-up-unrealized-tax-for-jurisdictions"></a><a name="to-set-up-unrealized-tax-for-jurisdictions"></a>To set up unrealized tax for jurisdictions
...
## <a name="to-set-up-adjustments-for-payment-discounts-in-a-tax-posting-group"></a><a name="to-set-up-adjustments-for-payment-discounts-in-a-tax-posting-group"></a><a name="to-set-up-adjustments-for-payment-discounts-in-a-tax-posting-group"></a>To set up adjustments for payment discounts in a tax posting group
...
## <a name="to-set-up-maximum-tax-correction-amounts"></a><a name="to-set-up-maximum-tax-correction-amounts"></a><a name="to-set-up-maximum-tax-correction-amounts"></a>To set up maximum tax correction amounts
