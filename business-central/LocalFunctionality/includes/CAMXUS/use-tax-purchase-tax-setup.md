...
## <a name="to-set-up-use-tax-for-a-purchase-order" />To set up use tax for a purchase order
...
## <a name="to-set-up-use-tax-details" />To set up use tax details
...
## <a name="to-set-up-purchase-tax-for-a-company" />To set up purchase tax for a company
...
## <a name="to-set-up-purchase-tax-for-a-location" />To set up purchase tax for a location
...
## <a name="to-set-up-purchase-tax-for-non-recoverable-tax" />To set up purchase tax for non-recoverable tax
1.  Choose the ![Lightbulb that opens the Tell Me feature.](../../../media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Tax Details**, and then choose the related link.  
2.  On the **Tax Details** page, choose the **New** action.  
