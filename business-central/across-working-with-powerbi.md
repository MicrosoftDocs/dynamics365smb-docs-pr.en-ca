...
> [!TIP]
> If you don't see the Power BI FactBox, it might be hidden on your workspace by personalization. Select the ![Settings.](media/ui-experience/settings_icon_small.png "Settings icon for role centre") icon, and then select **Personalize** action. For more information, see [Personalize Your Workspace](ui-personalization-user.md).
>
