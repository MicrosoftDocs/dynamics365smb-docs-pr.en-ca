...
---
# <a name="the-getaddressio-uk-postcodes-extension"></a>The GetAddress.io UK Postal Codes Extension
...
2. On the **Postal Code Search** page, in the **Postal Code** field, enter or choose the postal code.  
