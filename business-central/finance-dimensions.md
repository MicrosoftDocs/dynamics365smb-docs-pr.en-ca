...
description: You use dimensions to categorize entries, such as by department or project, so you can more easily track and analyse data to help you make good business decisions.
author: edupont04
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
ms.locfileid: "9605633"
---
# <a name="work-with-dimensions"></a>Work with Dimensions

Dimensions are values that categorize entries so you can track and analyse them on documents, such as sales orders. Dimensions can, for example, indicate the project or department an entry came from.  
