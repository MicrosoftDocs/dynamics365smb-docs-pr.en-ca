...
---
# <a name="mapping-the-tables-and-fields-to-synchronize" />Mapping the Tables and Fields to Synchronize
...
### <a name="to-create-new-records-during-synchronization" />To create new records during synchronization
