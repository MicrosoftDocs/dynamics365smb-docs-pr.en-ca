...
### <a name="to-update-finance-charge-memo-texts"></a><a name="to-update-finance-charge-memo-texts"></a><a name="to-update-finance-charge-memo-texts"></a>To update finance charge memo text
...
In addition, issuing the finance charge memo may result in GST/HST entries.
