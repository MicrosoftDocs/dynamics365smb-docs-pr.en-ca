...
### <a name="a-nameswitchaswitching-from-individual-acquisition-to-centralized-deployment-or-the-other-way-around" /><a name="switch"></a>Switching from individual acquisition to Centralized Deployment or the other way around
...
## <a name="deploy-the-add-in-by-using-centralized-deployment" />Deploy the add-in by using Centralized Deployment
...
### <a name="set-up-centralized-deployment-of-the-add-in" />Set up Centralized Deployment of the add-in
