...
|Show hidden actions and fields.|For a greyed (hidden) element, choose the arrowhead, and then choose <b>Show</b>.|The hidden element is again visible.|
