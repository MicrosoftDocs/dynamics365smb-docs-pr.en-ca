...
ms.author: bholtorf
---
# <a name="personalize-your-workspace" />Personalize Your Workspace
...
## <a name="to-start-personalizing-a-page-through-the-personalizing-banner" />To start personalizing a page through the **Personalizing** banner
...
## <a name="a-namewhatawhat-you-can-personalize" /><a name="What"></a>What You Can Personalize
...
## <a name="a-nameactionsapersonalizing-the-action-bar-and-menus" /><a name="Actions"></a>Personalizing the action bar and menus
...
## <a name="a-namepartsapersonalizing-parts" /><a name="Parts"></a>Personalizing Parts
...
## <a name="to-clear-personalization" />To clear personalization
