...
ms.author: bholtorf
---
# <a name="set-up-vat-statement-templates-and-vat-statement-names" />Set Up GST/HST Statement Templates and GST/HST Statement Names
...
## <a name="to-define-a-vat-statement" />To define a GST/HST statement
...
## <a name="to-preview-the-vat-statement" />To preview the GST/HST statement
