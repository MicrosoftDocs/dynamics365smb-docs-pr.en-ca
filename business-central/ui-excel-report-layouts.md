...
ms.locfileid: "9075742"
---
# <a name="working-with-excel-layouts"></a>Working with Excel Layouts

Excel report layouts are based on Microsoft Excel workbooks (.xlsx files). They let you create reports by using familiar Excel features for summarizing, analysing, and presenting data, like formulas, PivotTables and PivotCharts.
