...
# <a name="synchronizing-data-in-business-central-with-microsoft-dataverse" />Synchronizing Data in Business Central with Microsoft Dataverse
...
## <a name="standard-table-mapping-for-synchronization" />Standard Table Mapping for Synchronization
