...
# <a name="synchronizing-data-in-business-central-with-microsoft-dataverse"></a>Synchronizing Data in Business Central with Microsoft Dataverse
...
## <a name="standard-table-mapping-for-synchronization"></a>Standard table mapping for synchronization
...
## <a name="synchronize-data-from-multiple-companies-or-environments"></a>Synchronize data from multiple companies or environments
...
### <a name="specify-the-synchronization-direction"></a>Specify the synchronization direction
