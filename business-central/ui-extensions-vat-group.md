...
# <a name="the-vat-group-management-extension-for-the-united-kingdom" />The GST/HST Group Management Extension for the United Kingdom
...
## <a name="forming-a-vat-group" />Forming a GST/HST group
...
## <a name="set-up-a-vat-group" />Set up a GST/HST group
...
## <a name="set-up-vat-group-members" />Set up GST/HST group members
...
### <a name="vat-group-representative-uses-business-central-online" />GST/HST group representative uses Business Central online
...
### <a name="vat-group-representative-uses-business-central-on-premises" />GST/HST group representative uses Business Central on-premises
...
## <a name="set-up-the-vat-group-representative" />Set up the GST/HST group representative
...
## <a name="use-the-vat-group-management-features" />Use the GST/HST group management features
...
### <a name="review-vat-member-submissions" />Review GST/HST member submissions
...
### <a name="create-a-group-vat-return" />Create a group GST/HST return
