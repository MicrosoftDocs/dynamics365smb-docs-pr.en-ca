...
# <a name="synchronize-items-and-inventory" />Synchronize Items and Inventory
...
## <a name="define-item-synchronizations" />Define item synchronizations
...
## <a name="run-item-synchronization" />Run item synchronization
...
### <a name="image-synchronization-remarks" />Image synchronization remarks
