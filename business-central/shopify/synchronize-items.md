...
|**Prices including GST/HST**|Specifies whether price calculations for Shopify include GST/HST. Learn more at [Set up Taxes](setup-taxes.md).|
|**GST/HST Business Posting Group**|Specifies which GST/HST business posting group is used to calculate prices in Shopify. This should be the group you use for domestic customers. Learn more at [Set up Taxes](setup-taxes.md).|
