...
## <a name="define-item-synchronizations"></a>Define item synchronizations
...
|Description|Combines extended text and attributes if corresponding toggles on the Shopify shop card are enabled. Respects language code.|Not used.|
