...
7. Select entry with name *B2B* catalogue for which you want to synchronize prices.
...
## <a name="walkthrough-check-out-and-order-synchronization-for-individual-buyer-and-company-representative"></a>Walkthrough: Check out and order synchronization for Individual buyer and Company representative
...
#### <a name="run-the-synchronization"></a>Run the synchronization
