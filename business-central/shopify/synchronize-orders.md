...
While the imported Shopify order contains information about taxes, the taxes get recalculated when you create sales document. That's why it's important that the GST/HST/Tax settings are correct in [!INCLUDE[prod_short](../includes/prod_short.md)].
