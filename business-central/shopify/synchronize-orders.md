...
# <a name="synchronize-and-fulfill-sales-orders" />Synchronize and Fulfill Sales Orders
...
## <a name="run-the-order-synchronization" />Run the order synchronization
...
## <a name="synchronize-shipments-to-shopify" />Synchronize shipments to Shopify
