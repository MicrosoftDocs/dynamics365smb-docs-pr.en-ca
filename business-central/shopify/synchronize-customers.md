...
# <a name="synchronize-customers"></a>Synchronize Customers
...
4. The **Tax Area** field also contains a **Country Code** and **Province/State Name** pair. This pair is useful when the connector needs to convert a code to a name, or vice versa.
