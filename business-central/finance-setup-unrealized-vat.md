...
2. In the **General Ledger Setup** window, on the **General** FastTab, choose **Show More**, and then choose the **Unrealized Tax** check box.
3. Close the page.
4. choose the **Search for Page or Report** icon ![Lightbulb that opens the Tell Me feature](media/ui-search/search_small.png "Tell me what you want to do"), and enter **Tax Posting Setup**.
5. In the **Tax Posting Setup** window, choose the tax posting group, and then choose **Edit**.
