...
---
# <a name="analyze-list-data-using-data-analysis-mode" />Analyse list data using data analysis mode
...
## <a name="work-with-data-analysis-mode" />Work with data analysis mode
