...
---
# <a name="analyze-list-data-using-data-analysis-mode"></a><a name="analyze-list-data-using-data-analysis-mode"></a>Analyse list data using data analysis mode
...
## <a name="prerequisite"></a><a name="prerequisite"></a>Prerequisite
...
## <a name="work-with-data-analysis-mode"></a><a name="work-with-data-analysis-mode"></a>Work with data analysis mode
...
### <a name="data-area-1"></a><a name="data-area-1"></a>Data area (1)
...
### <a name="summary-bar-2"></a><a name="summary-bar-2"></a>Summary bar (2)
...
### <a name="columns-3"></a><a name="columns-3"></a>Columns (3)
...
### <a name="analysis-filters-4"></a><a name="analysis-filters-4"></a>Analysis filters (4)
...
### <a name="tabs-5"></a><a name="tabs-5"></a>Tabs (5)
...
## <a name="pivot-mode"></a><a name="pivot-mode"></a>Pivot mode
