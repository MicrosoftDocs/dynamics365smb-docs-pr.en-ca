...
## <a name="synchronizing-contacts-with-customers-vendors-employees-and-bank-accounts" />Synchronizing contacts with customers, vendors, employees, and bank accounts
