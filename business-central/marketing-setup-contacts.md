...
## <a name="to-assign-organizational-levels-to-a-contact" />To assign organizational levels to a contact
...
## <a name="synchronizing-contacts-with-customers-vendors-and-bank-accounts" />Synchronizing Contacts with Customers, Vendors, and Bank Accounts
