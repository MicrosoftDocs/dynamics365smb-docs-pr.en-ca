...
# <a name="view-the-status-of-synchronization-jobs" />View the Status of Synchronization Jobs
...
## <a name="to-view-and-resolve-synchronization-errors-for-coupled-records" />To view and resolve synchronization errors for coupled records
...
## <a name="to-view-the-synchronization-log-for-a-specific-manually-synchronized-record" />To view the synchronization log for a specific (manually synchronized) record
