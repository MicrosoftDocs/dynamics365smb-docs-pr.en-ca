...
### <a name="personalize-business-central"></a>Personalize Business Central
...
### <a name="manage-vat"></a>Manage GST/HST
#### [GST/HST management overview](finance-manage-vat.md)
#### <a name="setup-vat"></a>Setup GST/HST
...
### <a name="fulfill-service-contracts"></a>Fulfill Service Contracts
...
##### [Payment Scenario 1 - Domestic Payments ($ to $)](LocalFunctionality/Netherlands/payment-scenario-1-domestic-payments-lcy-to-lcy-.md)  
...
##### [Payment Scenario 3 - Foreign Payment ($ to FCY)](LocalFunctionality/Netherlands/payment-scenario-3-foreign-payment-lcy-to-fcy-.md)
...
##### [Set Up Delivery Reminder Terms, Levels, and Text](LocalFunctionality/Switzerland/how-to-set-up-delivery-reminder-terms-levels-and-text.md)
...
##### [Import Swiss Postal/ZIP Codes](LocalFunctionality/Switzerland/how-to-import-swiss-post-codes.md)
...
### <a name="customize-with-extensions"></a>Customize with Extensions
...
## <a name="synchronize-master-data-across-companies"></a>Synchronize Master Data Across Companies
