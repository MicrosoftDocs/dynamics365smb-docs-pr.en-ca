...
### [Manage GST/HST Rate Changes](finance-how-use-vat-rate-change-tool.md)
...
##### [GST/HST Registration Number Setup for Intrastat](LocalFunctionality/Denmark/vat-registration-no-intrastat.md)
#### Banking & Payments
...
##### [Set Up SII for GST/HST Reporting](LocalFunctionality/Spain/sii-setup.md)
...
#### VAT
##### [Make Tax Digital - GST/HST Returns submission](LocalFunctionality/UnitedKingdom/making-tax-digital-submit-vat-return.md)
...
#### [UK - GST/HST Group Management](ui-extensions-vat-group.md)
