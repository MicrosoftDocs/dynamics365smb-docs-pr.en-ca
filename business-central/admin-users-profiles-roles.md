...
## <a name="page-customization"></a><a name="page-customization"></a>Page Customization
...
## <a name="to-delete-all-personalizations-made-by-a-user"></a><a name="to-delete-all-personalizations-made-by-a-user"></a>To delete all personalizations made by a user
...
## <a name="to-delete-personalizations-for-specific-pages"></a><a name="to-delete-personalizations-for-specific-pages"></a>To delete personalizations for specific pages
