...
## <a name="page-customization" />Page Customization
...
## <a name="to-delete-all-personalizations-made-by-a-user" />To delete all personalizations made by a user
...
## <a name="to-delete-personalizations-for-specific-pages" />To delete personalizations for specific pages
