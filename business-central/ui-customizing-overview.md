...
ms.author: edupont
---
# <a name="customize-business-central"></a><a name="customize-business-central"></a><a name="customize-business-central"></a>Customize Business Central
...
|Install an app|Install apps that add functionality, change behaviour, provide access to new online services, and more. For example, Microsoft provides an app that provides integration with PayPal Payments Standard.|All users in all companies.|[Customizing with Apps](ui-extensions.md)|
